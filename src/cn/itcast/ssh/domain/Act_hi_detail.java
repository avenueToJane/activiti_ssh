...
public class Act_hi_detail implements Serializable{
	...
	public String toString() {
		return "Act_hi_detail [ID_=" + ID_ + ", TYPE_=" + TYPE_ + ", PROC_INST_ID_=" + PROC_INST_ID_
				+ ", EXECUTION_ID_=" + EXECUTION_ID_ + ", TASK_ID_=" + TASK_ID_ + ", ACT_INST_ID_=" + ACT_INST_ID_
				+ ", NAME_=" + NAME_ + ", VAR_TYPE_=" + VAR_TYPE_ + ", REV_=" + REV_ + ", TIME_=" + TIME_
